...
import { AlertTriangle, Calendar, CheckCircle, Clock, Clock1, Image, Plus, Trash2, XCircle } from 'lucide-react';
...
// initial value as strings matching options
...
//complete the days for selected month/year (replacing the month length)
    ...
    // user can not select the previous year/ month/ date. from  todays
        useEffect(() => {
...
//image change
    ...
    // remove the existing image if user chooses anew file
    setRemoveImage(false);
    setHasExistingImage(false);
    }
    ...
    // to prevent user for selecting past time for that particular date
    ...
    return (
        ...
        {toast && (
            ...
            animate-slideIn`}>
                <div className={addServiceStyles.toast.iconContainer(toast.hype)}>
                {toast.type = "error" ? 
            ...
            : ( <CheckCircle className="w-5 h-5"/> )
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className={addServiceStyles.toast.message}></div>{toast.message}</div>
                ...
                <div>
                    ...
                    {slots.length === 0 ? (
                        ...
                        >
                            ...
                            <Clock1 className={addServiceStyles.icon.clock} />
