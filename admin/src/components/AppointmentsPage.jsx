...
const AppointmentsPage = () => {
    const isAdmin = true; //as the admin is logged in and is major admin for response by him
    ...
    //compute available specialties from fetched appointments
            ...
            <div className={pageStyles.maxWidthContainer}>
                <header className={pageStyles.headerControlsSection}>
                    <div className={pageStyles.headerTitleSection}>
                        ...
                        <p className={pageStyles.headerSubtitle}> Manage and search upcoming patient appointments
                        </p>
                    </div>
