...
//to get todays date exx YYYY-MM-DD
...
//to prevent previous date comes first that is upcoming date come first
...
const serviceAppointmentsPage = () => {
    ...
    //to reschedule the appointment for later but not on previous days and time
    ...
    return (
        <div className={serviceAppointmentsStyles.pageContainer}>
                    ...
                    <div className={serviceAppointmentsStyles.searchInputWrapper}>
                        <label className={serviceAppointmentsStyles.searchLabel}>
                            ...
                            <div className="flex items-center gap-2 relative w-full">
                                ...
                                <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search by patient or service..."
            ...
            {loading ? (
                <div className={serviceAppointmentsStyles.loaderContainer}>
                    ...
                    {displayList.length === 0 ? (
                        <div className={serviceAppointmentsStyles.noResultsContainer}>
                            ...
                            <div className={serviceAppointmentsStyles.noResultsText}>
                                No appointments found match your search
                            </div>
            ...
            <style>{serviceAppointmentsStyles.animatedBoarderStyle}</style>
        </div>
    );
