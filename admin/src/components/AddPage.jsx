...
//HELPER FUNCTIONS
// this function will give output in minutes and according to that it will manage ap: pm
...
const AddPage = () => {
    ...
    //it will show a toast for 3 seconds
    useEffect(() => {
            ...
            <div className={s.maxWidthContainer + " " + s.formContainer}>
                <form onSubmit={handleAdd} className={s.formGrid}>
                    ...
                    <div className="relative">
                        <input className={s.inputBase + " " + s.inputWithIcon} placeholder="Doctor Password"
                    ...
                    <textarea className={s.textareaBase + "md:col-span-2"} rows={3} placeholder="About Doctor"
