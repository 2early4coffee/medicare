...
//helpers function
//this function converts array like input ito a clean array
...
const parseJsonArrayField = (field) => {
    ...
    // this function takes date-time slot strings and group them into YY-MM-DD with the  time
    ...
    try {
        ...
        try {
            ...
            if (existing.imagePublicId) {
                // it will remove the old image and replace with new
                try {
