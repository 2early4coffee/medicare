...
// this funtion will parse the time and return AM : PM
...
export const getServiceAppointments = async (req, res) => {
    ...
    console.error("getServiceAppointments unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
...
export const getServiceAppointmentById = async (req, res) => {
    ...
    console.error("getServiceAppointmentById unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
...
export const updateServiceAppointment = async (req, res) => {
    ...
    console.error("updateServiceAppointment unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
...
export const cancelServiceAppointment = async (req, res) => {
    ...
    console.error("cancelServiceAppointment unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
...
export const getServiceAppointmentStats = async (req, res) => {
    ...
    console.error("getServiceAppointmentStats unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
...
export const getServiceAppointmentsByPatient = async (req, res) => {
    ...
    console.error("getServiceAppointmentsByPatient unexpected error:", err);
    return res.status(500).json({ success: false, message: "Server error" });
    }
}
