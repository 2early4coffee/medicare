...
const Testimonial = () => {
    ...
    useEffect(() => {
        ...
        if (!isPaused) {
            ...
            if (scrollLeft.scrollTop >= scrollLeft.scrollHeight - scrollLeft.clientHeight) {
        ...
        <div className={testimonialStyles.container}>
            <div className={testimonialStyles.headerContainer}>
                ...
                <p className={testimonialStyles.subtitle}>
                    Real stories from doctors and patients sharing their
            ...
            <div className={testimonialStyles.grid}
                ...
                <div className={`${testimonialStyles.columnContainer} ${
                    ...
                    className={testimonialStyles.scrollContainer}>
                        {[...leftTestimonials, ...leftTestimonials, ...leftTestimonials].map((t,i) =>(
                            <TestimonialCard 
                            key={`L-${i}`} testimonial={t} direction="left" />
                        ))}
                    </div>
                </div>
                <div className={`${testimonialStyles.columnContainer} ${
                    ...
                    >
                        {[...rightTestimonials, ...rightTestimonials].map((t,i) =>(
                            <TestimonialCard 
                            key={`R-${i}`} testimonial={t} direction="right" />
                        ))}
